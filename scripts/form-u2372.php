...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Naam:</b></td><td>' . htmlentities($_REQUEST["custom_U2382"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Bericht:</b></td><td>' . htmlentities($_REQUEST["custom_U2389"],ENT_COMPAT,'UTF-8') . '</td></tr>';
