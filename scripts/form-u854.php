...
{
	$to = 'bryce.vandenbrande@immalle.be';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Naam:</b></td><td>' . htmlentities($_REQUEST["custom_U882"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Bericht:</b></td><td>' . htmlentities($_REQUEST["custom_U855"],ENT_COMPAT,'UTF-8') . '</td></tr>';
